...
def Ref():
    ...
    costofburger = cob*35000
    costoffilet = cofi*5000
    costofcheeseburger = cochee*5000
    costofdrinks = codr*2000

    costofmeal = "Ugx.",str('%.2f'% (costoffries +  costoflargefries + costofburger + costoffilet + costofcheeseburger + costofdrinks))
    ...
    Service="Ugx.",str('%.2f'% Ser_Charge)
    OverAllCost="Ugx.",str( PayTax + Totalcost + Ser_Charge)
    PaidTax="Ugx.",str('%.2f'% PayTax)
...
status = Label(f2,font=('aria', 16, 'bold'), width = 20, text="By Justine Robert Igune ", bd=2,relief=SUNKEN)
